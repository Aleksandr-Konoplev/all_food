...
class ReservationForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.table_deposits = {str(table.pk): table.min_deposit for table in self.fields["table"].queryset}
        ...
        self.fields["table"].widget.attrs.update({"class": "form-control", "placeholder": "Выберите стол"})
