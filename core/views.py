        ...
        context["stats_cards"] = [
            {
                ...
                "value": count_feedback,
                "description": "Сообщения от клиентов присланные через форму.",
            },
            {
                "title": "Пользователей",
            ...
            {
                "title": "Столиков",
                "value": Table.objects.count(),
                "description": "Доступные столики для бронирования.",
            },
            {
                "title": "Бронирований",
                "value": active_reservations_count,
                "description": "Бронирования, у которых время окончания еще не наступило.",
            },
        ]
        context["quick_links"] = [
