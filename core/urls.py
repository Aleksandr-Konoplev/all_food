...
from core.views import HomePageView, AboutPageView, ControlPanelView, ContentListView, ContentUpdateView, FeedbackListView, FeedbackDetailView, FeedbackDeleteView
